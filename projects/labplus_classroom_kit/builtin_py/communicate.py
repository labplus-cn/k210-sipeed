...
fm.register(25, fm.fpioa.GPIOHS9)
cam_led = GPIO(GPIO.GPIOHS9, GPIO.OUT)
cam_led.value(0)
                ...
                if cmd and isinstance(cmd, dict):
                    for key, value in cmd.items():
                        ...
                        # 获取超声波传感器测量值
                            ...
                            Response(distance)
                        elif key == 'SET_CAM_LED':
                            led_status = cmd['SET_CAM_LED']
                            cam_led.value(led_status)
                            Response(led_status)
                        # 控制马达
                        elif key == 'SET_MOTOR':
